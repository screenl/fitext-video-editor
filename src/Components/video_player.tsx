...
export default function player(
  ...
  function progressBar() {
    const highlightLeft = (timelineScrollPosition / timelineTotalWidth) * 100;
    const highlightWidth = (timelineVisibleWidth / timelineTotalWidth) * 100;
    ...
    return (
      <div className="z-10 mb-2 mt-4 flex h-5 w-full flex-row">
        ...
        <div className="mr-4 h-3 w-full rounded-full bg-gray-200 dark:bg-gray-700">
          ...
          ></div>
          <div
            className="absolute h-3 rounded-full bg-red-600 "
  ...
  return (
    <div className="flex h-full flex-row bg-white text-black dark:bg-gray-900 dark:text-white">
      ...
      <div className="relative flex h-full w-full flex-1 flex-col">
        {videoPreview(state, setstate, url, true)}
        {videoSpecs()}
        {progressBar()}
      </div>
    </div>
